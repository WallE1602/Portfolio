...
function mapProjectsData() {
    let projects = [
        {
            "title": "PropertyAI",
            "image": "images/projects/omdena.png",
            "type": "Open Source",
            "labels": [
                {
                    "title": "GitHub",
                    "link": "https://github.com/OmdenaAI/dhaka-bangladesh-real-estate-recommendation/tree/main"
                }
            ]
        },
        {
            "title": "PlatoVI",
            "image": "images/projects/platovi.png",
            "type": "Open Source",
            "labels": [
                {
                    "title": "GitHub",
                    "link": "https://github.com/WallE1602/PLATO_VI"
                }
            ]
        },
    ];
