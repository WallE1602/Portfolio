...
function downloadResume() {
    ...
    link.href = 'src/cv/SWCV_2024.pdf'; // Replace 'path/to/your/pdf/file.pdf' with the actual path to your PDF file
    link.download = 'SWCV_2024.pdf'; // Replace 'filename.pdf' with the desired name for the downloaded file
